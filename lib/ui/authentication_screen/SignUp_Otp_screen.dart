...
class SignUpOtpScreen extends StatefulWidget {
  final userId;
  final mobileNo;
  const SignUpOtpScreen({super.key, this.userId, this.mobileNo});
...
class _SignUpOtpScreenState extends State<SignUpOtpScreen> {
  ...
  Future<void> verifyOtp() async {
    try {
      ...
      final response = await apiServices.verifyOtp(widget.mobileNo, _enteredOTP);
      ...
      if (response['status_code'] == 200) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => RegistrationScreen(mobile: widget.mobileNo,userId: response['user_id'].toString(),),));
      } else {
        setState(() {
          isLoading = false;
        });
