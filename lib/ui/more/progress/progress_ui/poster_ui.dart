...
class PosterUi extends StatefulWidget {
  const PosterUi({super.key});

  @override
  State<PosterUi> createState() => _PosterUiState();
}

class _PosterUiState extends State<PosterUi> {
    ...
    return Column(
      children: [
        const PlatformNameUi(
          platformName: "PlatFormName :- POSTER",
        ),
        verticalSpace(10),
        Expanded(
          child: Container(
