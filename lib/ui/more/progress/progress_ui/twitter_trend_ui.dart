...
class TwitterTrendUi extends StatefulWidget {
  const TwitterTrendUi({super.key});

  @override
  State<TwitterTrendUi> createState() => _TwitterTrendUiState();
}

class _TwitterTrendUiState extends State<TwitterTrendUi> {
    ...
    return Column(
      children: [
        const PlatformNameUi(
          platformName: "PlatFormName :- TWITTER TREND",
        ),
        verticalSpace(10),
        Expanded(
          child: Container(
              ...
              rows: List<DataRow>.generate(data.length, (index) {
                ...
                return DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(Center(child: Text(item['Total Task/Completed'].toString()),)), // Converting to string for display
                    DataCell(Center(child: Container(height: 25,
